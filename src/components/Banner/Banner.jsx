...
import { Container, Header, Entity, Inner, Question, Text, Image } from "./BannerElement";
...
Banner.Image = function BannerImage({ children, ...restProps }) {
    const { open } = React.useContext(QuestionContext);
    return open ? <Image {...restProps}>{children}</Image> : null;
  };
