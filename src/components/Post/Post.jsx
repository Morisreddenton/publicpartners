      ...
      <PostCardContainer>
        <PostCard>
          ...
          <div className="right">
            ...
            <div className="cap">
              <p>
                Adding products to stock made easy for you to create, read,
                update & delete product from stock
              </p>
            </div>
            <div
              className="btn"
        ...
        <PostCard>
          ...
          <div className="right">
            ...
            <div className="cap">
              <p>
                We've got you covered, keep your clients busy daily on your
                application <samp>#AddArticleNow</samp>
              </p>
            </div>
            <div
              className="btn"
        ...
        <PostCard>
          ...
          <div className="right">
            ...
            <div className="cap">
              <p>
                Rating clients on their task keep them going, That's why we've
                got you covered with ratings.
              </p>
            </div>
            <div
              className="btn"
        ...
        <PostCard>
          ...
          <div className="right">
            ...
            <div className="cap">
              <p>
                Did you know morning inspiration quote from application makes it
